...
void main() {
  ...
  group('user-authored Dart-function macros (public API only)', () {
    ...
    test('block syntax: defwidget MyButton { ... } expands correctly', () async {
      // Block syntax gives macro authors structured field args instead of raw
      // string tokens.  defwidget2 MyButton { String label; Color? color; }
      // arrives as args = ['MyButton', ['String','label'], ['Color?','color']].
      defAsyncMacro('defwidget_block', (args) async {
      ...
      final out = await asyncCompileDartLike(
        'defwidget_block MyButton { String label; Color? color; }',
      );
